                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <br />
                            @if(isset($listings->image))
                            <img src="{{url('/images/buysell/'.$listings->image)}}" class="img-fluid img-thumbnail {{ $errors->has('image') ? 'is-invalid' : '' }}" alt="Image" height="200" width="200" />
                            @endif
                            @if($errors->has('image'))
                            <div class="invalid-feedback">
